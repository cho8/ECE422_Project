...
public class ClientHandler {
	...
	private static void initializeClientID() {
		...
		//		long[] key = new long[] {129048L, 1249081L, 89L, 9035717L}, 		user = "Client2");
		//		long[] key = new long[] {5139841L, 1839741L, 80808808L, 279381L}, 	user = "Client3");
		//		long[] key = new long[] {8018048L, 192837L, 938401983L, 2342L}, 	user= "Client4");
		//		long[] key = new long[] {1827L,11111L, 90923201L, 178461119L}, 	user ="Client5");
		//		long[] key = new long[] {361872L, 1421L, 9999147L, 22222222L}, 	user = "Client6");
	}
